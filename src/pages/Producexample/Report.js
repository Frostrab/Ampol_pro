            ...
            <div>
                ...
                <Tabs onChange={callback} type="card">
                    <TabPane tab="หน่วยงานที่ทดสอบ" key="1">
                        <Card title="หน่วยงานที่ทดสอบ" style={{ width: '100%' }} extra={<Button type="primary">ตกลง</Button>} >
                    ...
                    <TabPane tab="การพิจารณาหลักเกณฑ์ในการคัดเลือก วัตถุดิบ / สารเคมี / บรรจุภัณฑ์" key="3">
                        <Card title="การสรุปของคณะกรรมการ ความปลอดภัยของอาหาร" style={{ width: '100%' }} extra={<Button type="primary">ตกลง</Button>}>
                        <Row>
                        <Col lg={14} md={12} sm={24}>
