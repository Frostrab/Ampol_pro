      ...
      <div>
        ...
        <Card title="รายละเอียด" bordered={false}>
          ...
          <Form>
            ...
            <Row gutter={16}>
              <Col lg={6} md={12} sm={24}>
                <Checkbox onChange={onChange2}>Supplier ที่ราคาแพงกว่า และมีมากกว่า 1 ราย</Checkbox>
              </Col>
              <Col xl={{ span: 6, offset: 2 }} lg={{ span: 8 }} md={{ span: 12 }} sm={24}>
                <Checkbox onChange={onChange2}>Supplier รายใหม่เพิ่ม Itemใหม่ที่ฝ่ายอื่นหาให้
              <select>
                    <option >ก</option>
                    <option >ข</option>
                    <option >ค</option>
              ...
              <Col xl={{ span: 8, offset: 2 }} lg={{ span: 10 }} md={{ span: 24 }} sm={24}>
                <Checkbox onChange={onChange2}>Supplier ที่ฝ่ายอื่นหาให้
              <select>
                    <option >ก</option>
                    <option >ข</option>
                    <option >ค</option>
